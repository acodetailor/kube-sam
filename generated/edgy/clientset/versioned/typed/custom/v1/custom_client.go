...
import (
	...
	"builder/generated/edgy/clientset/versioned/scheme"
...
// CustomV1Client is used to interact with features provided by the custom.my.crd.com group.
type CustomV1Client struct {
	restClient rest.Interface
}

func (c *CustomV1Client) Units(namespace string) UnitInterface {
